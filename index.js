...
console.log(request.query);
   ...
   // . find({})  // u will get all movies
   .find(request.query)  // EPPOYUME QUERY STRING GA THAN VARUM
   .toArray();
  ...
  // without express.json u cant get o/p for post. u will get undefined
